...
efficiency [Koller and Friedman 2009].

[Jordan 2003] refers to graphical models as "probabilistic
...
(Conditional independence). Let $X$, $Y$ and $Z$ be discrete random variables. $X$ is *conditionally
...
probability tables* (CPTs) [Koller and Friedman
2009].
...
implied by $G$ [Bishop 2006; Koller and Friedman 2009].
...
Markov random field. [Domke 2014] Let $G$ be an undirected graph with
...
directionality of the relationship is unclear [Koller and Friedman 2009], and often
